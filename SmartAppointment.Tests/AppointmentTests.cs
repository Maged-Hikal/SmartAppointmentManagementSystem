...
namespace SmartAppointment.Tests
{
    public class AppointmentTests
    {
        ...
        {
            var appointment = new Appointment(DateTime.UtcNow, "John Doe", "user123", "Jhonedoe@smartapp.com", "+4656565656", "121212121212");
        ...
        {
            var appointment = new Appointment(DateTime.UtcNow, "Jane Smith", "user456", "jane@example.com", "+1234567890", "123456789012");
            appointment.Reject();
        ...
        {
            var appointment = new Appointment(DateTime.UtcNow, "Bob Johnson", "user789", "bob@example.com", "+0987654321", "987654321098");
            appointment.Cancel();
        ...
        public void Reschedule_Appointment_Should_Set_New_Date_And_Status()
        {
            ...
            var appointment = new Appointment(originalDate, "Alice Brown", "user101", "alice@example.com", "+1122334455", "112233445566");
        ...
        {
            var appointment = new Appointment(DateTime.UtcNow, "Charlie Wilson", "oldUser", "charlie@example.com", "+5544332211", "554433221199");
        ...
        public void Constructor_Should_Set_All_Properties_Correctly()
        {
            ...
            var appointment = new Appointment(date, customerName, userId, email, phoneNumber, ssn);
        ...
        {
            var appointment = new Appointment(DateTime.UtcNow, "Test User", "user123", optionalValue, optionalValue, optionalValue);
        ...
        {
            var appointment = new Appointment(DateTime.UtcNow, "Test User", "user123", "test@example.com", "+1234567890", "123456789012");
